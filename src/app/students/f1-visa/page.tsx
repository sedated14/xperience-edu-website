...
const highlights = [
  ...
  { title: 'Private Schools', description: 'Attend top private day schools or boarding schools', icon: Home },
  { title: 'Full Support', description: '24/7 support from dedicated program coordinators', icon: Shield },
]
        ...
        <div className="container-wide relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-white/80 mt-6 max-w-2xl">
              Attend a top American private or boarding school. Build your path to US universities with a world-class education and full academic support.
            </p>
      ...
      <section className="section bg-white">
        <div className="container-wide">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            {[
              { step: '01', title: 'Apply & Consult', desc: 'Complete our application and schedule a consultation. We assess your goals, academic level, and preferences.' },
              ...
              { step: '03', title: 'Acceptance & Visa', desc: 'Once accepted, we guide you through the I-20 process and F1 visa application with full support.' },
              { step: '04', title: 'Pre-Departure Prep', desc: 'Orientation, travel planning, health insurance, and everything you need for a smooth transition.' },
              { step: '05', title: 'Arrive & Thrive', desc: 'Welcome to America! Our coordinators provide ongoing support throughout your entire program.' },
            ].map((item) => (
