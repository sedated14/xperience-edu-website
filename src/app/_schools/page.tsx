          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white font-display">
                Enrich Your School
                <span className="block mt-2 bg-clip-text text-transparent bg-gradient-to-r from-secondary-400 to-accent-400 pb-2">With Global Diversity</span>
              </h1>
              ...
              <div className="relative aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute -bottom-6 -left-6 glass rounded-2xl p-4 shadow-elevated">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-600">Diversity</div>
                    </div>
                  </div>
                </div>
                <div className="absolute -top-6 -right-6 glass rounded-2xl p-4 shadow-elevated">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-neutral-900">Boost</div>
                      <div className="text-sm text-neutral-600">Enrollment</div>
                    </div>
                  </div>
                </div>
              </div>
